//
//  FireStorageDAOMessageTests.swift
//  FileStorageDAOTests
//
...
final class FireStorageDAOMessageTests: XCTestCase {

    private var dao: FileStorageDAO<Message, FSMessage>!

    override func setUp() {
        super.setUp()

        dao = FileStorageDAO(translator: FSMessageTranslator())
    }
