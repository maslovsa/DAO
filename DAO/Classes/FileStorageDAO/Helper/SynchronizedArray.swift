...
public class SynchronizedArray<Element> {
    private let queue = DispatchQueue(label: "io.scal.SynchronizedArray", attributes: .concurrent)
...
public extension SynchronizedArray {
    ...
    ///
    /// - Parameter predicate: A closure that takes an element of the sequence as its argument and returns a Boolean value indicating whether the element is a match.
    /// - Returns: The first index of the sequence that satisfies predicate, or nil if there is no element that satisfies predicate.
